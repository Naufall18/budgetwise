...
**Track every rupiah. Own your budget.**
...
- 📝 Create, edit, and delete Transaction entries with a clean Material 3 UI
...
```bash
git clone https://github.com/Naufall18/fintrack-mobile.git
cd fintrack-mobile
flutter pub get
flutter run
```
